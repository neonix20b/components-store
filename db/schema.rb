...
ActiveRecord::Schema[7.1].define(version: 2024_07_20_035230) do
  ...
  create_table "emails", force: :cascade do |t|
    ...
    t.index ["spree_order_id"], name: "index_emails_on_spree_order_id"
    t.index ["store_id"], name: "index_emails_on_store_id"
  end
  ...
  add_foreign_key "emails", "spree_orders"
  add_foreign_key "messages", "spree_users"
